"""Minimal end-to-end example using synthetic data, saving outputs for plotting."""
...
essential_save = "ivsurface_dist.npz"
...
def main():
    ...
    print(f"Saved distribution surfaces and observations to {essential_save}")
